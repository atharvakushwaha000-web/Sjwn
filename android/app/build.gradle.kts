...
android {
    ...
    buildTypes {
        release {
            ...
            signingConfig = signingConfigs.getByName("debug") // Configure custom release keystore for Google Play
        }
        debug {
...
dependencies {
    ...
    // AndroidX Media3 (ExoPlayer & Media Transformer for native high-performance splitting)
